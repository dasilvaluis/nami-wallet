...
export const MILKOMEDA = {
  mainnet: { protocol: '', address: '' },
  testnet: {
    protocol: '❤ cardano-evm-localnet-bridge ☠',
    address:
      'addr_test1qq6gwl46frfwfk593pqjg39vym476s64n9cmykdl7lv7w32jdqlum6v4sc3l3w9nmuf3ean86n2y7pl83tpxl2qjdw8qmjljz2',
  },
};
